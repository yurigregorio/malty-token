...
These are allocation categories, not current wallet balances or guarantees of circulation.

## Planned Initial Circulation
...
Up to **17.5M MALTY** is planned for initial availability, leaving **182.5M MALTY** reserved.
...
The current five reserve accounts are:
...
| MALTY Treasury | `6gkNMy3342qVUKSatW27zUAK22ops5Fu7G5J148MQZK6` | 75,000,000 | 0 |
| MALTY Team | `CvASopxtFapEhJ8r75UcHiisPVCfxv5ApGAqbwNagXmw` | 75,000,000 | 0 |

All five reserve accounts currently have zero MALTY. Planned allocations therefore do not represent current balances.
...
3. Planned initial circulation is **100,000,000 MALTY**; actual circulation must be determined from verifiable on-chain state.
