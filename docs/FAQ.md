...
Always verify the mint address rather than relying only on a token name or ticker.

## What is the total supply?

The fixed total supply is **1,000,000,000 MALTY** with **6 decimals**.
...
No. MALTY was created without a Freeze Authority.

## Is there a transfer tax?

No. MALTY uses the traditional SPL Token program configuration and has no token transfer tax.

## Why does the project still have a Metadata Update Authority?

The Metadata Update Authority is separate from the SPL Mint Authority. It is retained for metadata maintenance and cannot create additional MALTY.
...
No. MALTY is a memecoin. There is no promise or guarantee of price, liquidity, returns or future value.
