...
const copy = {
  en: {
    ...
    explore: "Discover MALTY", impact: "Explore MALTY Gives", storyEyebrow: "THE MALTY MISSION", storyTitle: "Community with a purpose.",
    ...
    tokenTitle: "Clear facts. Publicly verifiable.", tokenText: "The essentials of the official MALTY token, presented openly and without hiding the project structure behind marketing.",
    ...
    roadmapTitle: "Build the community. Create impact. Prove it.", faqTitle: "Quick answers", transparency: "Transparency center", copy: "Copy mint", copied: "Copied", copyFailed: "Copy failed",
    allocationTitle: "Published allocation plan", allocationNote: "These are planned allocations, not claims that reserve balances have already been distributed.",
  ...
  pt: {
    ...
    explore: "Conhecer MALTY", impact: "Conhecer MALTY Gives", storyEyebrow: "A MISSÃO MALTY", storyTitle: "Comunidade com propósito.",
    ...
    tokenTitle: "Dados claros. Verificáveis publicamente.", tokenText: "O essencial sobre o token oficial MALTY, apresentado de forma aberta e sem esconder a estrutura do projeto atrás do marketing.",
    ...
    roadmapTitle: "Construir a comunidade. Gerar impacto. Comprovar.", faqTitle: "Respostas rápidas", transparency: "Central de transparência", copy: "Copiar mint", copied: "Copiado", copyFailed: "Falha ao copiar",
    allocationTitle: "Plano de alocação publicado", allocationNote: "Estas são alocações planejadas, não uma afirmação de que os saldos das reservas já foram distribuídos.",
...
export default function Home() {
  ...
  return <main className="min-h-screen overflow-x-hidden bg-[#080a0d] text-[#f7f1e5] selection:bg-[#d9a53d] selection:text-black">
    <header className="sticky top-0 z-50 border-b border-white/[0.07] bg-[#080a0d]/85 backdrop-blur-2xl"><div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-3 sm:px-8"><a href="#top" className="flex items-center gap-3 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#e9b949]"><Image src={TOKEN_IMAGE} alt="MALTY" width={36} height={36} className="h-9 w-9 rounded-full border border-[#d9a53d]/45 object-cover"/><div className="leading-none"><p className="text-base font-black text-[#e9b949]">MALTY</p><p className="mt-1 text-[9px] uppercase tracking-[0.22em] text-white/35">Solana</p></div></a><nav className="hidden items-center gap-5 text-xs font-semibold text-white/50 md:flex">{t.nav.map((x,i)=><a key={x} href={`#${["story","token","gives","roadmap","faq"][i]}`} className="rounded-sm hover:text-[#e9b949] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#e9b949]">{x}</a>)}</nav><div className="flex rounded-full border border-white/10 bg-white/[0.035] p-1 text-[11px] font-bold">{(["en","pt"] as const).map(l=><button key={l} onClick={()=>setLanguage(l)} aria-pressed={language===l} className={`rounded-full px-3 py-1.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e9b949] ${language===l?"bg-[#e9b949] text-black":"text-white/45"}`}>{l.toUpperCase()}</button>)}</div></div></header>

    <section id="top" className="relative border-b border-white/[0.07]"><div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_76%_42%,rgba(217,165,61,0.17),transparent_28%)]"/><div className="relative mx-auto grid max-w-6xl items-center gap-8 px-5 py-12 sm:px-8 lg:grid-cols-[1.08fr_0.92fr] lg:py-16"><div><div className="inline-flex items-center gap-2 rounded-full border border-[#e9b949]/20 bg-[#e9b949]/[0.045] px-3 py-1.5 text-[10px] font-black tracking-[0.15em] text-[#e9b949]"><span className="h-1.5 w-1.5 rounded-full bg-emerald-400"/>{t.badge}</div><h1 className="mt-6 text-5xl font-black leading-[.92] tracking-[-.06em] sm:text-6xl lg:text-7xl">MALTY<span className="text-[#e9b949]">.</span></h1><p className="mt-4 text-xl font-bold sm:text-2xl">{t.headline}</p><p className="mt-4 max-w-xl text-sm leading-6 text-white/55 sm:text-base">{t.intro}</p><div className="mt-6 flex flex-wrap gap-3"><a href="#story" className="rounded-xl bg-[#e9b949] px-4 py-2.5 text-sm font-black text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white">{t.explore}</a><a href="/gives" className="rounded-xl border border-[#e9b949]/30 bg-[#e9b949]/[0.04] px-4 py-2.5 text-sm font-bold text-[#e9b949] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#e9b949]">🐾 {t.impact}</a></div><div className="mt-7 grid max-w-xl grid-cols-2 gap-px overflow-hidden rounded-2xl border border-white/[.08] bg-white/[.08] sm:grid-cols-4"><Metric label="Supply" value="1B"/><Metric label="Tax" value="0%"/><Metric label="Decimals" value="6"/><Metric label="Network" value="Solana"/></div></div><div className="relative flex min-h-[310px] items-center justify-center"><div className="absolute h-72 w-72 rounded-full bg-[#e9b949]/10 blur-[70px]"/><div className="relative h-64 w-64 rounded-full border-[7px] border-[#b87d21] bg-gradient-to-br from-[#ffe59a] via-[#d9a53d] to-[#6f4210] p-2 shadow-2xl sm:h-72 sm:w-72"><Image src={TOKEN_IMAGE} alt="Official MALTY token artwork" width={288} height={288} priority className="h-full w-full rounded-full border-4 border-black/25 object-cover"/></div></div></div></section>

    <section className="border-b border-white/[.07] bg-[#0c0f13]"><div className="mx-auto max-w-6xl px-5 py-8 sm:px-8"><div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between"><div><Eyebrow>PROJECT STATUS</Eyebrow><p className="mt-2 text-lg font-black">Public status · 12 Sep 2026</p></div><div className="grid grid-cols-2 gap-2 sm:grid-cols-4"><Status label="Mainnet" value="Live"/><Status label="Mint Authority" value="Revoked"/><Status label="Freeze Authority" value="None"/><Status label="MALTY Gives" value="Planned"/></div></div><div className="mt-4 flex flex-wrap gap-4 text-xs"><a href="/transparency" className="font-bold text-[#e9b949]">Verify transparency →</a><a href="/updates" className="font-bold text-white/55 hover:text-white">View change history →</a></div></div></section>
    ...
    <section id="token" className="border-b border-white/[.07] bg-[#0c0f13]"><div className="mx-auto max-w-6xl px-5 py-11 sm:px-8"><Eyebrow>OFFICIAL TOKEN</Eyebrow><h2 className="mt-2 text-3xl font-black">{t.tokenTitle}</h2><p className="mt-3 text-sm text-white/50">{t.tokenText}</p><div className="mt-5 grid grid-cols-2 gap-2 sm:grid-cols-3"><Stat label="Supply" value="1B MALTY"/><Stat label="Transfer tax" value="0%"/><Stat label="Decimals" value="6"/><Stat label="Mint Authority" value="Revoked"/><Stat label="Freeze Authority" value="None"/><Stat label="Network" value="Solana"/></div><div className="mt-4 rounded-xl border border-[#e9b949]/20 p-4"><p className="break-all font-mono text-xs text-white/60">{MINT}</p><div className="mt-3 flex flex-wrap gap-4"><button onClick={copyMint} className="text-xs font-bold text-[#e9b949] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#e9b949]">{copyState==="copied"?t.copied:copyState==="error"?t.copyFailed:t.copy}</button><a href={`https://explorer.solana.com/address/${MINT}`} target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-white/45 hover:text-white">Solana Explorer ↗</a></div></div></div></section>

    <section className="border-b border-white/[.07]"><div className="mx-auto max-w-6xl px-5 py-11 sm:px-8"><Eyebrow>TOKENOMICS</Eyebrow><div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><h2 className="text-3xl font-black">{t.allocationTitle}</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-white/45">{t.allocationNote}</p></div><a href="/transparency" className="text-sm font-bold text-[#e9b949]">Full reserve architecture →</a></div><div className="mt-6 grid gap-2 sm:grid-cols-5">{allocation.map(([name,pct,amount])=><Allocation key={name} name={name} pct={pct} amount={amount}/>)}</div></div></section>

    <section id="gives" className="border-b border-black/10 bg-[#f2ecdf] text-[#17130d]"><div className="mx-auto grid max-w-6xl gap-8 px-5 py-12 sm:px-8 lg:grid-cols-2 lg:items-center"><div><div className="inline-flex rounded-full bg-[#9a6517]/10 px-3 py-1 text-[10px] font-black tracking-[.18em] text-[#9a6517]">🐾 MALTY GIVES · {t.givesStatus}</div><h2 className="mt-4 text-3xl font-black sm:text-4xl">{t.givesTitle}</h2><p className="mt-4 text-sm leading-6 text-black/60">{t.givesText}</p><p className="mt-4 rounded-xl border border-[#9a6517]/15 bg-white/50 p-3 text-xs text-black/50">{t.givesNote}</p><a href="/gives" className="mt-5 inline-flex text-sm font-bold text-[#9a6517]">MALTY Gives →</a></div><div className="grid grid-cols-2 gap-2"><Impact n="01" title={language==="pt"?"Comunidade indica":"Community surfaces"}/><Impact n="02" title={language==="pt"?"Projeto revisa":"Project reviews"}/><Impact n="03" title={language==="pt"?"Ação documentada":"Action documented"}/><Impact n="04" title={language==="pt"?"Impacto comprovado":"Impact proven"}/></div></div></section>
    ...
    <footer className="border-t border-white/[.07] px-5 py-7"><div className="mx-auto flex max-w-6xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"><div><p className="font-black text-[#e9b949]">MALTY · Small Dog. Big Community.</p><div className="mt-2 flex flex-wrap gap-3 text-[10px] font-bold text-white/40"><a href="/about">About</a><a href="/transparency">Transparency</a><a href="/gives">Gives</a><a href="/updates">Updates</a><a href="/docs">Docs</a></div></div><p className="max-w-2xl text-[10px] leading-5 text-white/30">{t.risk}</p></div></footer>
  </main>;
}
...
function Allocation({name,pct,amount}:{name:string;pct:string;amount:string}){return <div className="rounded-2xl border border-white/[.08] bg-white/[.025] p-4"><p className="text-xs font-black text-[#e9b949]">{pct}</p><p className="mt-3 text-sm font-black">{name}</p><p className="mt-1 text-[10px] text-white/35">{amount} MALTY · planned</p></div>}
...
function Faq({q,a}:{q:string;a:string}){return <details className="rounded-xl border border-white/[.08] px-4 py-3"><summary className="cursor-pointer text-sm font-bold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#e9b949]">{q}</summary><p className="mt-2 text-xs leading-5 text-white/48">{a}</p></details>}
