...
const copy = {
  en: {
    ...
    walletEyebrow: "MALTY IMPACT RESERVE — 50M MALTY (5%)",
    walletTitle: "MALTY Impact",
    walletNote: "The canonical tokenomics allocate a dedicated 50,000,000 MALTY (5%) reserve to MALTY Impact, funded by reducing Ecosystem from 20% to 15%. Funding this reserve wallet is not itself a donation — it becomes an initiative only once the program is active and an action is documented.",
  ...
  pt: {
    ...
    walletEyebrow: "RESERVA MALTY IMPACT — 50M MALTY (5%)",
    walletTitle: "MALTY Impact",
    walletNote: "A tokenomics canônica reserva 50.000.000 MALTY (5%) dedicados ao MALTY Impact, financiados pela redução do Ecosystem de 20% para 15%. Financiar essa carteira não é, por si só, uma doação — ela só vira uma iniciativa quando o programa estiver ativo e uma ação for documentada.",
