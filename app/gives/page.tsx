    ...
    <main className="min-h-screen bg-[#080a0d] text-[#f7f1e5]">
      <div className="mx-auto max-w-5xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <section className="mt-10 grid gap-3 sm:grid-cols-3">
          ...
          <Info title="Impact dashboard" text="Once real actions exist, publish completed initiatives and evidence instead of projected impact numbers." />
        </section>

        <section className="mt-10 rounded-2xl border border-white/[0.08] p-5">
          <p className="text-sm font-black text-white/80">Current status</p>
          <p className="mt-2 text-xs leading-5 text-white/42">MALTY Gives remains planned. No organization is currently presented as a beneficiary, no contribution has been claimed, and no future amount is guaranteed. The public record should only change after real, documented activity exists.</p>
        </section>
