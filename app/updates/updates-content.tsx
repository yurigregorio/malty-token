...
const copy = {
  en: {
    ...
    updates: [
      ...
      ["2026-09", "Liquidity Reserve funded", "Completed", "The Liquidity Reserve now holds its full canonical allocation of 500,000,000 MALTY."],
      ["2026-09", "All reserves fully funded", "Completed", "All six reserve wallets were funded to their full canonical allocation, independently verified against the Solscan Holders view for the official mint."],
      ["2026-09", "Live on Raydium", "Completed", "The official MALTY/SOL pool (Standard AMM / CPMM) launched on Raydium, funded with 5,000,000 MALTY from the Liquidity Reserve + 0.5 SOL. Test buy and sell both confirmed."],
      ["2026-09", "Jupiter & Birdeye", "Completed", "MALTY became tradeable through Jupiter (which routes to the official Raydium pool) and trackable on Birdeye."],
      ["2026-09", "Listing requests submitted", "Submitted", "Listing requests were submitted to CoinGecko and CoinMarketCap, and a Jupiter token verification request was also submitted. None of these listings is confirmed yet."],
      ["2026-09", "Native Malty Swap", "Completed", "A non-custodial swap page (/swap) launched, trading SOL/USDC for MALTY directly against the official Raydium pool from the visitor's own wallet. The app never holds funds or signs on the user's behalf; every transaction is a real Raydium quote the connected wallet reviews and approves."],
    ],
  ...
  pt: {
    ...
    updates: [
      ...
      ["2026-09", "Reserva de Liquidez financiada", "Concluído", "A Reserva de Liquidez agora tem sua alocação canônica completa de 500.000.000 MALTY."],
      ["2026-09", "Todas as reservas totalmente financiadas", "Concluído", "As seis carteiras de reserva foram financiadas com sua alocação canônica completa, verificadas de forma independente na visão de Holders do Solscan para o mint oficial."],
      ["2026-09", "Ao vivo na Raydium", "Concluído", "O pool oficial MALTY/SOL (Standard AMM / CPMM) foi lançado na Raydium, financiado com 5.000.000 MALTY da Reserva de Liquidez + 0,5 SOL. Compra e venda de teste confirmadas."],
      ["2026-09", "Jupiter e Birdeye", "Concluído", "O MALTY passou a ser negociável via Jupiter (que roteia para o pool oficial na Raydium) e rastreável no Birdeye."],
      ["2026-09", "Pedidos de listagem enviados", "Enviado", "Pedidos de listagem foram enviados para CoinGecko e CoinMarketCap, além de um pedido de verificação na Jupiter. Nenhuma dessas listagens está confirmada ainda."],
      ["2026-09", "Malty Swap nativo", "Concluído", "Uma página de swap não-custodial (/swap) foi lançada, trocando SOL/USDC por MALTY diretamente contra o pool oficial na Raydium, a partir da própria carteira do visitante. O app nunca guarda fundos nem assina em nome do usuário; cada transação é uma cotação real da Raydium que a carteira conectada revisa e aprova."],
    ],
