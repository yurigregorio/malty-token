...
const copy = {
  en: {
    ...
    updates: [
      ...
      ["2026-09", "Live on Raydium", "Completed", "The official MALTY/SOL pool (Standard AMM / CPMM) launched on Raydium with 5,000,000 MALTY + 0.5 SOL initial liquidity. Test buy and sell both confirmed."],
    ],
  ...
  pt: {
    ...
    updates: [
      ...
      ["2026-09", "Ao vivo na Raydium", "Concluído", "O pool oficial MALTY/SOL (Standard AMM / CPMM) foi lançado na Raydium com liquidez inicial de 5.000.000 MALTY + 0,5 SOL. Compra e venda de teste confirmadas."],
    ],
