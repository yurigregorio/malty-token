...
export function RecentSwaps({
  ...
  return (
    <div className="mt-4">
      <p className="mb-2 px-0.5 text-[11px] font-semibold tracking-[0.08em] text-white/40">
        {t.recentSwapsTitle}
      </p>
        ...
        <ul className="space-y-1.5">
          {entries.map((entry) => {
            ...
            return (
              <li
                key={entry.signature}
                className="flex items-center justify-between gap-3 rounded-xl border border-white/[0.08] bg-white/[0.02] px-3.5 py-2.5"
              >
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-[11px] text-white/40">
                    ...
                    <span className="text-emerald-300">{t.confirmedLabel}</span>
                  </p>
                </div>
                <a
                  ...
                  className="shrink-0 text-[11px] font-semibold text-white/50 hover:text-white"
                >
                  {t.viewTransaction} ↗
                </a>
              </li>
