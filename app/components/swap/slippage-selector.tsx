  ...
  return (
    <div className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-3">
      <div className="flex flex-wrap items-center gap-2">
        <span className="flex shrink-0 items-center gap-1 text-xs font-semibold text-white/70">
          {t.slippageLabel}
        ...
        <button
          ...
          aria-label={t.custom}
          className="shrink-0 rounded-lg border border-white/[0.1] p-1.5 text-white/50 transition-colors hover:border-[#e9b949]/35 hover:text-[#e9b949]"
        >
      ...
      {!customError && isHighSlippage(slippageBps) && (
        <p className="mt-1.5 text-[11px] text-[#e9b949]/90">{t.highSlippageWarning}</p>
      )}
