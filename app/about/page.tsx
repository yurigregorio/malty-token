  ...
  return (
    <main className="min-h-screen bg-[#080a0d] text-[#f7f1e5]">
      <div className="mx-auto max-w-5xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <section className="mt-10"><p className="text-[10px] font-black tracking-[0.2em] text-[#e9b949]">PROJECT STEWARDSHIP</p><h2 className="mt-2 text-2xl font-black">Clear responsibilities, public records.</h2><p className="mt-3 max-w-3xl text-sm leading-6 text-white/48">MALTY is currently stewarded by a project team responsible for development, public documentation, community operations and the design of MALTY Gives. The project does not present those responsibilities as decentralized governance today. Material changes should be reflected in public documentation and project updates.</p><div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4"><Steward title="Development" text="Maintain the public application and technical safeguards."/><Steward title="Documentation" text="Keep token facts, policies and changes publicly understandable."/><Steward title="Community" text="Create transparent participation channels as the project grows."/><Steward title="MALTY Gives" text="Define eligibility, evidence and reporting standards before activation."/></div></section>
        ...
        <section className="mt-10 rounded-2xl border border-white/[0.08] bg-white/[0.025] p-6"><p className="text-[10px] font-black tracking-[0.2em] text-[#e9b949]">PUBLIC COMMITMENT</p><p className="mt-3 max-w-3xl text-sm leading-6 text-white/48">Publish what can be verified, clearly label what remains planned, document material project changes, and avoid presenting future intentions as completed achievements.</p></section>

        <div className="mt-10 flex flex-wrap gap-3"><a href="/gives" className="rounded-xl bg-[#e9b949] px-4 py-2.5 text-sm font-black text-black">Explore MALTY Gives</a><a href="/transparency" className="rounded-xl border border-white/12 px-4 py-2.5 text-sm font-bold">Transparency center</a><a href="/updates" className="rounded-xl border border-white/12 px-4 py-2.5 text-sm font-bold">Project updates</a><a href="/docs" className="rounded-xl border border-white/12 px-4 py-2.5 text-sm font-bold">Documentation</a></div>
      </div>
    </main>
  );
}
