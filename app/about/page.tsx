  ...
  return (
    <main className="min-h-screen bg-[#080a0d] text-[#f7f1e5]">
      <div className="mx-auto max-w-5xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <p className="mt-5 max-w-2xl text-sm leading-6 text-white/52">MALTY is a community-driven project built on Solana. It combines a transparent token structure, a recognizable identity, public documentation and a long-term mission to build community and create positive impact for animal welfare.</p>
